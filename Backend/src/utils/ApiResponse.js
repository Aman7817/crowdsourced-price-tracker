//  this class is for sending API responses in a clean way
class ApiResponse {
    /**
     * Constructor: this is where we set up the response
     * 
     *  statusCode - The status of the request (e.g., 200 for success, 400 for error).
     *  data - The data you're sending back (could be an object, array, whatever).
     * {string} [message="Success"] - Optional message (default is "Success").
     */
